from sqlalchemy import create_engine, Column, String, Decimal, Integer, Boolean, DateTime, Text, ForeignKey, CheckConstraint
...
DATABASE_URL = os.getenv("DATABASE_URL", f"postgresql://postgres:{SUPABASE_API_KEY}@{SUPABASE_URL}:5432/postgres")
